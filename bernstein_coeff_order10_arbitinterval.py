...
def bernstein_coeff_order10_new(n, tmin, tmax, t_actual):
		...
		P = jnp.hstack((P0, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10 ))
		
		Pdot = jnp.hstack((P0dot, P1dot, P2dot, P3dot, P4dot, P5dot, P6dot, P7dot, P8dot, P9dot, P10dot ))/l

		Pddot = jnp.hstack((P0ddot, P1ddot, P2ddot, P3ddot, P4ddot, P5ddot, P6ddot, P7ddot, P8ddot, P9ddot, P10ddot ))/(l**2)
